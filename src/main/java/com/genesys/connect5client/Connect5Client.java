package com.genesys.connect5client;
...
import com.genesys.connect.dto.Connect5ResponseDto;
import com.genesys.connect.util.MessageConstants;
...
public class Connect5Client {
	...
	private static void loadConfidproperties() throws IOException {
		...
		InputStream input = Connect5Client.class.getClassLoader().getResourceAsStream("config.properties");
